...
Así podés estudiar con total comodidad, mientras la Universidad Isaac Newton (UIN) se te ayuda a construir tu futuro profesional 🍎.', false);
...
Este formato te permite llevar la carrera con mucha flexibilidad, aprovechando las clases en línea y asistiendo solo cuando realmente es necesario.', false);
...
¿Podrías contarme qué carrera te interesa?', false);
...
Así tu proceso es mucho más sencillo, seguro y sin complicaciones 🌟', false);
...
🎓 Inicio de lecciones: 31 de agosto del 2026', false);
...
🗓️ Del 31 de agosto al 6 de setiembre 2026', false);
...
🗓️ Del 7 al 11 de setiembre 2026', false);

  SELECT id INTO cat_id FROM public.categorias WHERE conjunto_id = new_conjunto_id AND name = 'Información académica clave';
  INSERT INTO public.mensajes (categoria_id, sub_categoria, title, excerpt, is_pinned) VALUES
  (cat_id, NULL, 'Modalidad', 'Nuestra modalidad está diseñada para impulsar tus metas con la flexibilidad que necesitas y la calidad que te merecés. 💫
...
✔️ Presencialidad obligatoria únicamente en los cursos de laboratorio, garantizando el aprendizaje práctico que te prepara para el mundo real, según el cronograma que en cada caso se facilite.', false);
...
Estos beneficios te permiten avanzar con tranquilidad y permitir a la Universidad Isaac Newton que te acompañe a construir tu futuro 🚀💙.', false);

  SELECT id INTO cat_id FROM public.categorias WHERE conjunto_id = new_conjunto_id AND name = 'Información académica clave';
  INSERT INTO public.mensajes (categoria_id, sub_categoria, title, excerpt, is_pinned) VALUES
  (cat_id, NULL, 'Requisitos para matricular (por grado) - Bachillerato', '📚 Requisitos para Bachillerato:
• Fotografía del documento de identidad (ambos lados).
• Fotografía del título de Bachillerato en Educación Media.
• Fotografía tamaño pasaporte o selfie frontal y formal.', false);

  SELECT id INTO cat_id FROM public.categorias WHERE conjunto_id = new_conjunto_id AND name = 'Información académica clave';
  INSERT INTO public.mensajes (categoria_id, sub_categoria, title, excerpt, is_pinned) VALUES
  (cat_id, NULL, 'Requisitos para matricular (por grado) - Licenciatura', '🎓 Requisitos para Licenciatura:
• Fotografía del documento de identidad (ambos lados).
• Fotografía del título de Bachillerato en Educación Media.
...
• Fotografía tamaño pasaporte.', false);

  SELECT id INTO cat_id FROM public.categorias WHERE conjunto_id = new_conjunto_id AND name = 'Información académica clave';
  INSERT INTO public.mensajes (categoria_id, sub_categoria, title, excerpt, is_pinned) VALUES
  (cat_id, NULL, 'Requisitos para matricular (por grado) - Maestría', '🎓 Requisitos para Maestría:
• Fotografía del documento de identidad (ambos lados).
• Fotografía del título de Bachillerato en Educación Media.
• Fotografía del título de Bachillerato Universitario afín.
• Fotografía tamaño pasaporte.
• Documento que compruebe haber realizado 150 horas de TCU.', false);
...
Si desea, puedo brindarle una simulación de pagos según la carrera que le interesa. Será un gusto acompañarle en este proceso para que la UIN te acompañe a Construir Tu Futuro 🚀💙.', false);
...
Con esa información puedo darte el monto exacto que tendrías que cancelar al matricular y el valor de cada cuota.', false);
...
Quedo atenta para ayudarte con lo que necesités y acompañarte en este proceso para que la UIN te acompañe a Construir Tu Futuro 🚀💙.', false);
...
Al matricularlo, recibirás una convocatoria para una reunión informativa donde se explica todo el proceso, el cronograma y los pasos a seguir 📋🚀💙.', false);

  SELECT id INTO cat_id FROM public.categorias WHERE conjunto_id = new_conjunto_id AND name = 'Financiamiento y costos';
  INSERT INTO public.mensajes (categoria_id, sub_categoria, title, excerpt, is_pinned) VALUES
  (cat_id, NULL, 'Práctica Profesional', '🏢 El costo de la Práctica Profesional es de ₡370 000.

Si deseás iniciar el proceso, podés indicarme y te orientamos sobre los pasos a seguir 🚀💙.', false);
...
Si deseás iniciar el proceso, con gusto te acompaño en los próximos pasos 🚀💙.', false);
...
El costo de esta materia es de ₡174 616,90. ¿Te gustaría saber más sobre cómo funciona el laboratorio? 🚀💙', false);
...
El costo de esta materia es de ₡87 308,45 más ₡30 000 por costos de la gira (incluye transporte, póliza estudiantil y merienda). Si querés, puedo darte más detalles 🚀💙.', false);
...
Si querés que te calcule el total del cuatrimestre según tus materias, con gusto lo hago 🚀💙.', false);
...
Si deseás asegurar tu cupo, puedo ayudarte a completar tu proceso de matrícula de inmediato. Solo indicame cuántas materias te gustaría llevar 🚀💙.', false);
...
Si querés, puedo calcularte el total a pagar según las materias que deseás llevar 🚀💙.', false);
...
Si deseás asegurar tu cupo, puedo ayudarte a completar tu proceso de matrícula de inmediato. Solo necesito que me confirmés cuántas materias te gustaría llevar 🚀💙.', false);
...
Si deseás asegurar tu cupo, puedo ayudarte a completar tu proceso de matrícula de inmediato 🚀💙.', false);
...
🔹 7. Guía completa
También cuento con la guía oficial de uso de Acamsys, con pasos ilustrados. Si la necesitás, te la comparto con gusto.', false);
...
Además, te recuerdo que el proceso de matrícula lo podemos hacer por este medio, sin necesidad de que te presentes personalmente a la sede 🏡. ¡Así de fácil y conveniente! ¿Te gustaría matricular? 💻', false);
...
Debés indicar tu nombre completo, número de cédula y el trámite por el cual se realiza el pago.', false);
...
¿Te gustaría enviarme los documentos para comenzar? 💙🚀', false);
...
El TCU tiene un costo administrativo de: ₡30 640,95 con IVA incluido.', false);
...
📨 Para iniciar el trámite, debés enviar un correo electrónico al departamento de Registro de la sede correspondiente 🏫. Ellos verificarán que cumplás con todos los requisitos y te indicarán los pasos a seguir para el depósito del dinero y los demás trámites 🧾✅.', false);
...
Me avisás cuando lo llenás y enviás, por favor 😉', false);

  SELECT id INTO cat_id FROM public.categorias WHERE conjunto_id = new_conjunto_id AND name = 'Correos del proceso de matrícula';
  INSERT INTO public.mensajes (categoria_id, sub_categoria, title, excerpt, is_pinned) VALUES
  (cat_id, NULL, 'Correo de pre-matrícula - Asunto del correo', '¡Asegurá tu lugar hoy y viví una experiencia extraordinaria en la UIN!', false);
...
Con entusiasmo,', false);

  SELECT id INTO cat_id FROM public.categorias WHERE conjunto_id = new_conjunto_id AND name = 'Correos del proceso de matrícula';
  INSERT INTO public.mensajes (categoria_id, sub_categoria, title, excerpt, is_pinned) VALUES
  (cat_id, NULL, 'Correo de bienvenida — matrícula formalizada - Asunto del correo', '¡Bienvenid@ a la UIN! Tu matrícula está lista para un cuatrimestre extraordinario', false);
...
2. Para conocer más sobre el uso de nuestras plataformas, podés conectarte el día [xxxxxx] a las [xxxxx] para una sesión de capacitación de nuestras plataformas para estudiantes de nuevo ingreso.', false);
